    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-white border-r border-slate-200 flex-shrink-0 hidden md:flex flex-col fixed h-full">
            ...
            <nav class="flex-1 mt-4 overflow-y-auto">
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="#" 
                        class="flex items-center px-6 py-3 text-sm font-medium text-slate-400 hover:bg-slate-50 hover:text-[#0d7a70] transition-colors cursor-not-allowed"
                        title="Halaman Pengguna (Segera Hadir)">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="#" 
                        class="flex items-center px-6 py-3 text-sm font-medium text-slate-400 hover:bg-slate-50 hover:text-[#0d7a70] transition-colors cursor-not-allowed"
                        title="Halaman Rekomendasi (Segera Hadir)">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="#" 
                        class="flex items-center px-6 py-3 text-sm font-medium text-slate-400 hover:bg-slate-50 hover:text-[#0d7a70] transition-colors cursor-not-allowed"
                        title="Halaman Artikel (Segera Hadir)">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 flex flex-col min-w-0 md:ml-64 w-full">
            ...
            <header class="h-16 bg-white border-b border-slate-200 flex items-center justify-end px-8 space-x-5 sticky top-0 z-10 print:hidden">
                <!-- Notification Bell -->
                <button class="text-slate-400 hover:text-[#0d7a70] focus:outline-none transition-colors relative">
                ...
                <!-- Settings Gear -->
                <button class="text-slate-400 hover:text-[#0d7a70] focus:outline-none transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
